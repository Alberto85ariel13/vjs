 ...
 */
export function reduceRight(f: any, firstValue: any, array?: any): any {
    return [curryReduceRight(f, firstValue), array && [...array].reduceRight(f, firstValue)][arguments.length - 2]
}
